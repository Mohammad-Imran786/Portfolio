      ...
      <div className="max-w-6xl mx-auto h-full flex items-center justify-between px-4">
        ...
        <div className="flex items-center gap-4">
          <HashLink
            ...
            to="#contact"
            scroll={scrollWithOffset}
            className="bg-blue-500 hover:bg-blue-600 px-4 py-2 md:px-5 md:py-2 rounded-full text-white hover:scale-105 transition-all duration-300 ease-in-out cursor-pointer text-sm md:text-base"
          >
            Contact Me
          </HashLink>
